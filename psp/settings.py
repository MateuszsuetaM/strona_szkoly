...
import os
PHOTOLOGUE_PATH = 'artykul.utils.get_image_path'
...
SECRET_KEY = '($363zckjt@wqg+7br@e^dw$85liu_fl3h+75k_k*d&_2i%_%8'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/home/mateusz/projekt/artykul/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
